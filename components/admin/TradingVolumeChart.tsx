...
const tooltipStyles =
  "rounded-md border border-[rgb(var(--app-border))] bg-[#12151b]/90 px-3 py-2 text-xs shadow-lg backdrop-blur";
...
export default function TradingVolumeChart({ data }: { data: Point[] }) {
  return (
    <div className="rounded-2xl bg-[rgb(var(--app-surface))] border border-white/5 p-5">
      <p className="text-sm text-[rgb(var(--app-text-muted))] mb-3">Trading Volume</p>
      <div className="h-56">
