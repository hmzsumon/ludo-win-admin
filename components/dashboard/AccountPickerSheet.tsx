...
export function AccountPickerSheet({
  ...
  return (
    <Sheet open={open} onOpenChange={onOpenChange}>
      <SheetContent side="bottom" className="bg-[#0b0e11]/95 text-[rgb(var(--app-text))]">
        <SheetHeader>
          <SheetTitle className="text-left">Confirm Your Plan</SheetTitle>
        </SheetHeader>
        <div className="mt-4 space-y-4">
          <div className="rounded-xl border border-[rgb(var(--app-border))] bg-[rgb(var(--app-surface-2))]/70 p-4 text-sm">
            {summary}
          </div>
