...
export function PlanCard({
  ...
  return (
    ...
    >
      <Card
        className={`h-full rounded-2xl border border-[rgb(var(--app-border))] bg-[#111418] text-[rgb(var(--app-text))] shadow-xl ${
      ...
      >
        ...
        <CardContent>
          <div className="rounded-xl border border-[rgb(var(--app-border))] bg-[rgb(var(--app-surface-2))]/60 p-4 text-sm">
