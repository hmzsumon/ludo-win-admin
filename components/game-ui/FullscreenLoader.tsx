...
export default function FullscreenLoader({
  ...
  return (
    ...
    >
      ...
      {/* Card */}
      <div className="relative w-full max-w-md px-6 py-7 rounded-2xl border border-[rgb(var(--app-border))] bg-black/50 backdrop-blur-md shadow-[0_10px_40px_rgba(0,0,0,.6)]">
        {/* Logo / Title */}
        <div className="mb-5 flex items-center justify-center text-[rgb(var(--app-text))]">
          {logo ?? (
        ...
        {/* Progress Bar */}
        <div className="w-full h-3 rounded-full bg-[rgb(var(--app-surface-3))]/80 overflow-hidden">
          <div
        ...
        {/* Percentage */}
        <div className="mt-3 text-center text-sm font-semibold text-[rgb(var(--app-text))] tabular-nums">
          {progress.toFixed(0)}%
        </div>

        {/* Tiny helper text */}
        <div className="mt-1 text-center text-xs text-[rgb(var(--app-text-muted))]">
          Preparing assets…
        </div>
      </div>
    </div>
