    ...
    <>
      ...
      <div
        className={[
          ...
          "rounded-t-2xl border-t border-[rgb(var(--app-border))] bg-[rgb(var(--app-surface))] shadow-2xl",
      ...
      >
        <div className="flex items-center justify-between border-b border-[rgb(var(--app-border))] px-4 py-3">
          ...
          <button
            onClick={onClose}
            className="rounded p-1 text-[rgb(var(--app-text-muted))] hover:text-[rgb(var(--app-text))]"
            aria-label="Close"
          >
            <X className="h-5 w-5" />
          </button>
