...
export default function Header({ open, onToggle }: Props) {
  ...
  return (
    <header className="fixed inset-x-0 top-0 z-50 h-16 border-b border-[rgb(var(--app-border))] bg-[rgb(var(--app-bg))]/90 backdrop-blur supports-[backdrop-filter]:bg-[rgb(var(--app-bg))]/75 transition-colors">
      {/* ফুল-উইডথ কন্টেইনার */}
      <div className="mx-auto flex h-full w-full items-center justify-between px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex min-w-0 items-center gap-3">
          ...
          <button
            className="rounded-lg p-2 text-[rgb(var(--app-text-muted))] hover:bg-[rgb(var(--app-surface-2))] hover:text-[rgb(var(--app-text))] md:hidden"
            onClick={onToggle}
        ...
        <div className="flex items-center gap-1 sm:gap-2">
          ...
          <button
            className="rounded-lg p-2 text-[rgb(var(--app-text-muted))] hover:bg-[rgb(var(--app-surface-2))] hover:text-[rgb(var(--app-text))]"
            onClick={() => {
              setNotifOpen(true);
              setUserOpen(false);
              setBalanceOpen(false);
          ...
          <div ref={userRef} className="relative hidden md:block">
            <button
              ...
              className={`rounded-lg p-2 text-[rgb(var(--app-text-muted))] hover:bg-[rgb(var(--app-surface-2))] hover:text-[rgb(var(--app-text))] ${
                userOpen ? "ring-1 ring-[rgb(var(--app-border))]" : ""
              }`}
            >
