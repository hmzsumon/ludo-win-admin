...
>(({ side = "right", className, children, ...props }, ref) => (
  <SheetPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        "fixed z-50 grid gap-4 bg-[rgb(var(--app-surface))] text-[rgb(var(--app-text))] shadow-2xl border border-[rgb(var(--app-border))] p-4",
...
const SheetHeader = ({
  ...
  <div
    className={cn("flex flex-col gap-1 text-[rgb(var(--app-text-soft))]", className)}
    {...props}
  />
);
...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Title
    ref={ref}
    className={cn("text-sm font-medium text-[rgb(var(--app-text))]", className)}
    {...props}
  />
));
...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Description
    ref={ref}
    className={cn("text-sm text-[rgb(var(--app-text-muted))]", className)}
    {...props}
  />
));
