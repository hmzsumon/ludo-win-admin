        ...
        >
          ...
          <SheetFooter className="mt-4">
            <button
              ...
              className="rounded-xl px-4 py-2 bg-[rgb(var(--app-surface-2))]/70 text-[rgb(var(--app-text))] hover:bg-[rgb(var(--app-surface-3))]/80"
            >
              Cancel
            </button>
            <button
        ...
        >
          ...
          <SheetFooter className="mt-4">
            ...
            <button
              ...
              className="rounded-xl px-4 py-2 bg-[#FF6A1A] text-[rgb(var(--app-text))] hover:bg-[#ff7d38] disabled:opacity-50"
            >
