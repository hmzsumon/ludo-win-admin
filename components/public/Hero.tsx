...
const Hero: React.FC = () => (
  <section className="relative overflow-hidden bg-[rgb(var(--app-surface))]">
    <Container className="grid grid-cols-1 items-center gap-10 py-16 md:grid-cols-2 md:py-24">
      <div>
        <h1 className="text-4xl font-extrabold leading-tight text-[rgb(var(--app-text))] sm:text-5xl md:text-6xl">
          Upgrade the way
        ...
        <p className="mt-4 max-w-xl text-[rgb(var(--app-text-soft))]">
        ...
        <div className="mt-6 flex flex-wrap items-center gap-3">
          ...
          <Button
            className="border border-[rgb(var(--app-border))] bg-neutral-900 text-neutral-200"
            icon={PlayCircle}
          >
            Take a tour
          </Button>
        </div>
        <div className="mt-6 grid grid-cols-2 gap-4 text-xs text-[rgb(var(--app-text-muted))] sm:grid-cols-4">
          {[
