...
const CTASection: React.FC = () => (
  <section className="bg-[rgb(var(--app-surface))] pb-16">
    <Container>
      <Card className="flex flex-col items-center justify-between gap-6 border-0 bg-gradient-to-br from-neutral-900 to-black p-8 sm:flex-row">
        <div>
          <h3 className="text-xl font-bold text-[rgb(var(--app-text))] sm:text-2xl">
            Trade with a trusted broker today
          </h3>
          <p className="mt-1 text-sm text-[rgb(var(--app-text-soft))]">
