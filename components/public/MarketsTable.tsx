...
const MarketsTable: React.FC = () => (
  <section id="markets" className="bg-[rgb(var(--app-surface))] pb-16">
    <Container>
      <SectionTitle
      ...
      <Card className="overflow-hidden p-0">
        <div className="overflow-x-auto">
          <table className="min-w-full divide-y divide-neutral-800">
            <thead className="bg-neutral-900/50 text-left text-xs uppercase tracking-widest text-[rgb(var(--app-text-muted))]">
              <tr>
            ...
            <tbody className="divide-y divide-neutral-800">
              {rows.map((r) => (
                <tr key={r.symbol} className="text-sm text-neutral-200">
                  <td className="px-6 py-4 font-mono font-semibold text-[rgb(var(--app-text))]">
                    {r.symbol}
                  </td>
