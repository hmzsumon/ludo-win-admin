    ...
    <form onSubmit={submit} className="space-y-4">
      ...
      <Field label="Email address" error={errors.email?.message}>
        <div className="relative">
          <Mail
            className="pointer-events-none absolute left-3 top-1/2 -translate-y-1/2 text-[rgb(var(--app-text-muted))]"
            size={16}
          />
          <Input
            type="email"
          ...
          <button
            ...
            className="absolute right-1 top-1/2 -translate-y-1/2 rounded-lg bg-emerald-600 px-3 py-1.5 text-xs font-semibold text-[rgb(var(--app-text))] hover:bg-emerald-500 disabled:opacity-60"
