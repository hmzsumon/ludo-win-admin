...
const VerifyEmailForm: React.FC<{ onSuccess?: () => void }> = ({
  ...
  return (
    <form onSubmit={submit} className="space-y-4">
      ...
      <div className="flex items-center gap-2 rounded-md border border-[rgb(var(--app-border))] bg-neutral-900/50 px-3 py-2">
        <Mail size={16} className="text-[rgb(var(--app-text-muted))]" />
