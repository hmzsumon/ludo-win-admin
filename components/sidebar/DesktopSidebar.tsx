    ...
    >
      ...
      <div
        className={[
          ...
          "[scrollbar-width:auto] [&::-webkit-scrollbar]:w-2",
      ...
      {/* collapse control */}
      <div className="flex w-full shrink-0 justify-end border-t border-[rgb(var(--app-border))] bg-[rgb(var(--app-surface))] px-1 pt-2">
        <button
          onClick={() => dispatch(toggleSidebar())}
          className="flex h-9 w-9 items-center justify-center rounded-full border border-[rgb(var(--app-border))] bg-neutral-900 text-[rgb(var(--app-text-soft))] hover:border-neutral-700 hover:text-[rgb(var(--app-text))]"
