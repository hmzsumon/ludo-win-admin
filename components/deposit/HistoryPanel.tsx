...
export default function HistoryPanel({
  ...
  return (
    <div className="border-b border-[rgb(var(--app-border))] bg-[rgb(var(--app-surface))] px-6 py-4">
      <h3 className="mb-3 flex items-center text-sm font-medium text-neutral-200">
        <FiClock className="mr-2 text-[rgb(var(--app-text-muted))]" /> Deposit history
      </h3>
        ...
        {items.map((d) => (
          ...
          >
            <div className="flex items-start justify-between">
              <div>
                <p className="font-medium text-[rgb(var(--app-text))]">${d.amount} USDT</p>
                <p className="text-xs text-[rgb(var(--app-text-muted))]">{d.date}</p>
              </div>
              ...
              <div className="text-right">
                ...
                <div className="mt-1 flex items-center justify-end">
                  ...
                  <button
                    ...
                    className="ml-1 rounded-full p-1 text-[rgb(var(--app-text-muted))] hover:bg-neutral-800 hover:text-neutral-200"
