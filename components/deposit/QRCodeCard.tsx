  ...
  return (
    <div className="rounded-xl border border-emerald-900/30 bg-emerald-500/10 p-4 text-center">
      {isLoading ? (
        ...
        <div className="mx-auto mb-3 flex h-48 w-48 items-center justify-center rounded-md bg-[rgb(var(--app-surface-2))]/70">
          {qr ? (
            <img
              src={qr}
              alt="Deposit QR code"
            ...
            <div className="text-sm text-[rgb(var(--app-text-muted))]">No QR available</div>
          )}
        </div>
      )}
