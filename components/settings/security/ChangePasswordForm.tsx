  ...
  return (
    <form onSubmit={submit} className="space-y-3">
      ...
      <label className="block text-sm">
        <span className="text-[rgb(var(--app-text-muted))]">Current password</span>
        <div className="relative">
          <input
            ...
            className="mt-1 w-full rounded-lg border border-[rgb(var(--app-border))] bg-neutral-900 px-3 py-2 pr-10 outline-none focus:ring-2 focus:ring-emerald-600/40"
          />
          <button
            type="button"
      ...
      {/* new password */}
      <label className="block text-sm">
        <span className="text-[rgb(var(--app-text-muted))]">New password</span>
        <div className="relative">
          <input
      ...
      {/* confirm */}
      <label className="block text-sm">
        <span className="text-[rgb(var(--app-text-muted))]">Confirm new password</span>
        <div className="relative">
          <input
      ...
      <button
        type="submit"
        disabled={isLoading}
        className="w-full rounded-xl bg-emerald-600 px-4 py-2 font-semibold text-[rgb(var(--app-text))] hover:bg-emerald-500 disabled:opacity-50"
      >
