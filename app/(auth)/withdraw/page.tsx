...
export default function WithdrawPage() {
  ...
  return (
    <div className="min-h-screen bg-[rgb(var(--app-surface))] px-3 py-5 md:px-6 md:py-8">
      <motion.div
      ...
      >
        {/* ── card ──────────────────────────────────────────── */}
        <div className="overflow-hidden rounded-2xl border border-[rgb(var(--app-border))] bg-[rgb(var(--app-surface-2))]/70 ring-1 ring-emerald-800/10">
          {/* ── header ─────────────────────────────────────── */}
          {/* ── header (responsive pills) ───────────────────────────── */}
          <div className="relative border-b border-[rgb(var(--app-border))] bg-gradient-to-r from-emerald-600 to-cyan-600 p-4 text-neutral-950">
            {/* top row: back + title (mobile: stacked) */}
            <div className="flex flex-col items-stretch gap-3 sm:flex-row sm:items-center sm:justify-between">
              <Link
                href="/dashboard"
                className="inline-flex items-center self-start rounded-lg bg-black/10 px-3 py-1.5 text-sm font-medium text-[rgb(var(--app-text))] hover:bg-[rgb(var(--app-surface-2))]/60"
              >
                <FiArrowLeft className="mr-2" /> Back
              </Link>

              {/* title: center on mobile, pill-look */}
              <h1 className="mx-auto rounded-xl bg-white/20 px-4 py-1 text-center text-base font-extrabold tracking-wide text-[rgb(var(--app-text))] shadow-sm sm:mx-0 sm:text-lg">
                Withdraw USDT
              </h1>
            ...
            <div className="mt-3 grid grid-cols-2 gap-2 sm:mt-4 sm:flex sm:flex-wrap sm:items-center sm:gap-2">
              ...
              <span className="inline-flex items-center justify-between gap-2 rounded-full border border-emerald-700/30 bg-emerald-500/10 px-3 py-1 text-xs text-emerald-100 sm:justify-center sm:text-[13px]">
                ...
                <strong className="text-[rgb(var(--app-text))]/95">${minWithdraw}</strong>
              </span>
              ...
              <span className="inline-flex items-center justify-center gap-2 rounded-full border border-emerald-700/30 bg-emerald-500/10 px-3 py-1 text-xs text-emerald-100 sm:text-[13px]">
                Fee: <strong className="text-[rgb(var(--app-text))]/95">5%</strong>
              </span>
              ...
              <span className="col-span-2 inline-flex items-center justify-between gap-2 rounded-full border border-emerald-700/30 bg-emerald-500/10 px-3 py-1 text-xs text-emerald-100 sm:col-span-1 sm:justify-center sm:text-[13px]">
                <span>Available:</span>
                <strong className="text-[rgb(var(--app-text))]/95">
          ...
          <div className="p-5">
            {step === "form" ? (
              ...
              >
                ...
                <div>
                  ...
                  <div className="relative">
                    <span className="pointer-events-none absolute left-3 top-1/2 -translate-y-1/2 text-[rgb(var(--app-text-muted))]">
                      $
                    </span>
                    <input
                      type="number"
                      ...
                      className="w-full rounded-lg border border-[rgb(var(--app-border))] bg-neutral-900/70 px-9 py-2.5 text-sm text-[rgb(var(--app-text))] outline-none placeholder:text-neutral-500 focus:ring-2 focus:ring-emerald-600/40"
                      step="0.01"
                      min={minWithdraw}
                    />
                  </div>
                  ...
                  {/* ── inline calc row ─────────────────────── */}
                  {amount && !amountError && (
                    <div className="mt-2 grid grid-cols-2 gap-2 text-xs text-[rgb(var(--app-text-soft))] md:grid-cols-3">
                      <div className="rounded-lg border border-[rgb(var(--app-border))] bg-neutral-900/50 px-3 py-1.5">
                        Fee (5%):{" "}
                      ...
                      <div className="col-span-2 hidden rounded-lg border border-[rgb(var(--app-border))] bg-neutral-900/50 px-3 py-1.5 md:block">
                        Network:{" "}
                        ...
                        <button
                          ...
                          className={[
                            ...
                            active
                              ...
                              : "border-[rgb(var(--app-border))] bg-[rgb(var(--app-surface-2))]/70 text-[rgb(var(--app-text-soft))] hover:border-neutral-700",
                          ].join(" ")}
                        >
                          {n}
                        </button>
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full rounded-lg border border-[rgb(var(--app-border))] bg-neutral-900/70 px-3 py-2.5 font-mono text-sm text-[rgb(var(--app-text))] outline-none placeholder:text-neutral-500 focus:ring-2 focus:ring-emerald-600/40"
                    required
                  />
                </div>
              ...
              >
                ...
                <div className="flex justify-center gap-2">
                  {[...Array(6)].map((_, i) => (
                    <input
                      ...
                      className="h-12 w-10 rounded-lg border border-[rgb(var(--app-border))] bg-[rgb(var(--app-surface-2))]/70 text-center text-lg font-semibold text-[rgb(var(--app-text))] outline-none focus:ring-2 focus:ring-emerald-600/40"
                    />
                  ))}
                </div>
                ...
                <button
                  ...
                  className="w-full rounded-lg border border-[rgb(var(--app-border))] bg-[rgb(var(--app-surface-2))]/70 px-4 py-2 text-sm text-[rgb(var(--app-text-soft))] hover:border-neutral-700"
                >
            ...
            {/* ── notes / guidelines ────────────────────────── */}
            <div className="mt-6 overflow-hidden rounded-xl border border-[rgb(var(--app-border))]">
              <div className="flex items-center gap-2 border-b border-[rgb(var(--app-border))] bg-[rgb(var(--app-surface-2))]/70 px-4 py-2">
              ...
              <div className="space-y-3 p-4 text-sm">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-[rgb(var(--app-text-muted))]">
