...
const BindWalletPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-transparent text-slate-900">
      {/* Top App Bar */}
      <div className="sticky top-0 z-10 flex items-center gap-3 bg-gradient-to-r from-emerald-600 to-teal-700 px-4 py-3 text-white">
        <button
          type="button"
      ...
      <form onSubmit={onSubmit} className="mx-auto w-full max-w-md px-4 py-5">
        {/* Card */}
        <div className="rounded-xl border border-[rgb(var(--app-border))] bg-[rgb(var(--app-surface))] p-4 shadow-sm">
          {/* Select group */}
          <div>
                ...
                className={`flex items-center gap-2 rounded-lg border px-3 py-2 transition
                 ${
                   group === "bkash"
                     ...
                     : "border-[rgb(var(--app-border))] hover:bg-[rgb(var(--app-surface-2))]"
                 }`}
              >
                <div className="flex h-7 w-7 items-center justify-center rounded bg-[rgb(var(--app-surface-2))] shadow">
          ...
          <div className="mt-4">
            ...
            <input
              value={ewalletType}
              readOnly
              className="w-full rounded-lg border border-[rgb(var(--app-border))] bg-[rgb(var(--app-surface-2))] px-3 py-2 text-sm outline-none"
            />
          </div>
          ...
          <div className="mt-4">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full rounded-lg border border-[rgb(var(--app-border))] bg-[rgb(var(--app-surface))] px-10 py-2 text-sm outline-none focus:border-teal-500 focus:ring-2 focus:ring-teal-200"
              />
            </div>
          ...
          <div className="mt-2">
            ...
            <div className="relative">
              ...
              <input
                ...
                placeholder="******"
                className="w-full rounded-lg border border-[rgb(var(--app-border))] bg-[rgb(var(--app-surface))] px-10 py-2 pr-10 text-sm outline-none focus:border-teal-500 focus:ring-2 focus:ring-teal-200"
              />
              <button
                type="button"
          ...
          <button
            type="submit"
            disabled={!isValid}
            className="mt-5 w-full rounded-lg bg-[rgb(var(--app-surface-3))] py-3 text-base font-medium text-[rgb(var(--app-text-soft))] transition
