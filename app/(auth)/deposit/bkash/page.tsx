...
export default function BkashPage() {
  ...
  return (
    <div>
      ...
      <div className=" min-h-screen bg-transparent text-[rgb(var(--app-text))] flex items-start justify-center p-4">
        <div className="w-full max-w-md rounded-lg border border-[#00493B] bg-[#01241D] shadow-xl">
          ...
          <div className="p-4 space-y-4">
            ...
            <button
              disabled={!isValid}
              className="mt-2 w-full rounded bg-[#4CAF50] py-3 text-center text-sm font-semibold text-[rgb(var(--app-text))] transition
