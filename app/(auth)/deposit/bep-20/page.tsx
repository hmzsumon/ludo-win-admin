...
export default function DepositPage() {
  ...
  return (
    <div className="min-h-screen bg-[rgb(var(--app-surface))] px-1 py-4 md:px-6 md:py-8">
      <div className="mx-auto w-full max-w-4xl">
        ...
        <DepositHeader
          ...
          backLink={
            <Link
              href="/dashboard"
              className="inline-flex items-center text-sm text-[rgb(var(--app-text-soft))] hover:text-[rgb(var(--app-text))]"
            >
        ...
        {/* ── card ───────────────────────────────────────────── */}
        <div className="overflow-hidden rounded-2xl border border-[rgb(var(--app-border))] shadow-xl">
          {/* header strip (emerald gradient) */}
          <div className="bg-gradient-to-r from-emerald-600 to-cyan-600 px-6 py-4 text-[rgb(var(--app-text))]">
            <div className="flex items-center justify-between">
              ...
              <button
                ...
                className="rounded-md bg-[rgb(var(--app-surface-3))]/80 px-3 py-1.5 text-xs font-medium hover:bg-white/15"
              >
          ...
          {/* body */}
          <div className="space-y-6 bg-[rgb(var(--app-surface))] p-6">
            {/* QR code or loader */}
            <QRCodeCard
              isLoading={isLoading}
              qr={qrCodeImage}
