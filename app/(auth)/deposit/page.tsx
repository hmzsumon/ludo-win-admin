...
const ALL_ITEMS: DepositItem[] = [
  ...
  },
  {
    ...
    name: "BinancePay",
    Icon: BinanceIcon,
    colorClass: "text-[rgb(var(--app-text-soft))]",
  ...
  return (
    <div className="mx-auto max-w-6xl px-3 py-4 md:px-6 md:py-6">
      ...
      <div className="mb-4 flex flex-col items-start justify-between gap-3 sm:flex-row sm:items-center">
        <h1 className="text-xl font-semibold text-[rgb(var(--app-text))]">Deposit</h1>
      ...
      {/* <div className="mb-4 flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
        <div className="relative w-full sm:w-72">
          ...
          <input
            ...
            className="w-full rounded-lg border border-[rgb(var(--app-border))] bg-[rgb(var(--app-surface-2))]/70 px-9 py-2 text-sm text-neutral-200 outline-none placeholder:text-neutral-500 focus:ring-2 focus:ring-emerald-600/50"
          />
        </div>

        <div className="flex flex-wrap items-center gap-2">
          <div className="flex items-center gap-1 rounded-lg border border-[rgb(var(--app-border))] bg-[rgb(var(--app-surface-2))]/70 px-2 py-1.5 text-xs text-[rgb(var(--app-text-soft))]">
              ...
              <button
                ...
                className={[
                  ...
                  t === tag
                    ...
                    : "border border-[rgb(var(--app-border))] bg-[rgb(var(--app-surface-2))]/70 text-[rgb(var(--app-text-soft))] hover:border-neutral-700",
                ].join(" ")}
              >
                {t}
              </button>
      ...
      {/* ── empty state ──────────────────────────────────────── */}
      {items.length === 0 && (
        <div className="mt-8 rounded-xl border border-[rgb(var(--app-border))] bg-neutral-900/50 p-6 text-center">
          <TriangleAlert className="mx-auto mb-2 h-6 w-6 text-[rgb(var(--app-text-muted))]" />
