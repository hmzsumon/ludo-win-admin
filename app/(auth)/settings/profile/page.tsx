      ...
      <VerificationSteps
        sections={[
          ...
          },
          {
            ...
            openByDefault: false,
            content: (
              <div className="space-y-3 text-[rgb(var(--app-text-soft))]">
                <p className="text-sm">
                  You can add your ID info later. For now we’ll keep this
                  collapsed to match the mock.
                </p>
                <ul className="list-disc pl-5 text-sm text-[rgb(var(--app-text-muted))]">
                ...
                <button
                  onClick={startKyc}
                  className="w-full rounded-xl border border-[rgb(var(--app-border))] bg-[rgb(var(--app-surface-2))]/70 px-4 py-3 text-sm text-[rgb(var(--app-text-soft))] hover:bg-neutral-900 hover:text-[rgb(var(--app-text))]"
                >
                  Complete now
                </button>
              </div>
          ...
          },
          {
            ...
            content: (
              <div className="space-y-4">
                ...
                <button
                  disabled
                  className="w-full rounded-xl border border-[rgb(var(--app-border))] bg-[rgb(var(--app-surface-2))]/70 px-4 py-3 text-sm text-neutral-500"
                >
                  Complete now
                </button>
              </div>
