...
export default function NotificationsPage() {
  ...
  return (
    <div className="mx-auto max-w-2xl pb-8 pt-4">
      <h1 className="px-4 pb-2 text-2xl font-bold text-[rgb(var(--app-text))]">
        Notifications
      </h1>
      <p className="px-4 text-sm text-[rgb(var(--app-text-muted))]">
      ...
      <div className="flex items-center justify-center w-full mt-4 ">
        ...
        <button
          ...
          className="inline-flex items-center gap-2 rounded-lg border w-full border-white/15 px-3 py-1.5 text-sm font-semibold hover:bg-[rgb(var(--app-surface-3))]/80 transition-colors disabled:opacity-60"
          title={
            pushSupported
      ...
      <div className="mt-4 overflow-hidden rounded-2xl border border-[rgb(var(--app-border))]/80 bg-neutral-900/40">
        ...
        <div className="border-t border-[rgb(var(--app-border))]/70 px-4 py-3 text-sm font-semibold text-[rgb(var(--app-text-soft))]">
          Operations
        </div>
