...
export default function ChangeContactPage() {
  ...
  return (
    <div className="mx-auto max-w-2xl space-y-4 pb-8 pt-4">
      <h1 className="px-4 pb-1 text-3xl font-extrabold text-[rgb(var(--app-text))]">
        Change Security
      </h1>

      <div className="overflow-hidden rounded-2xl border border-[rgb(var(--app-border))]/80 bg-neutral-900/40">
        <RadioRow
          label="Email"
          sub={maskedEmail}
          value="email"
