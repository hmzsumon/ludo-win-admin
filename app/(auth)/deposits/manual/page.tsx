      ...
      <div className="mx-auto max-w-4xl p-6 md:p-8">
        ...
        {preview && (
          <Card className="mt-4 p-4">
            {/* ────────── user summary ────────── */}
            <div className="rounded-xl border border-[rgb(var(--app-border))] p-4">
...
function Field({ label, value }: { label: string; value?: string }) {
  return (
    <div className="rounded-lg border border-[rgb(var(--app-border))] bg-[rgb(var(--app-surface-2))]/70 px-3 py-2">
      <div className="text-[11px] uppercase tracking-wide text-[rgb(var(--app-text-muted))]">
        {label}
      </div>
...
function Stat({
  ...
  return (
    <div className="rounded-lg border border-[rgb(var(--app-border))] bg-[rgb(var(--app-surface-2))]/70 px-3 py-3">
      <div className="text-[11px] uppercase tracking-wide text-[rgb(var(--app-text-muted))]">
        {title}
      </div>
      <div
