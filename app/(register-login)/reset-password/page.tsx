...
export default function ResetPasswordPage() {
  ...
  return (
    <div className="mx-auto max-w-md px-3 py-6">
      <h1 className="mb-1 text-2xl font-bold text-[rgb(var(--app-text))]">
        Create new password
      </h1>
      ...
      <form onSubmit={submit} className="space-y-4">
        ...
        <label className="block text-sm">
          ...
          <div className="relative">
            ...
            <input
              ...
              className="mt-1 w-full rounded-lg border border-[rgb(var(--app-border))] bg-neutral-900 px-9 py-2 pr-10 outline-none focus:ring-2 focus:ring-emerald-600/40"
              placeholder="••••••••"
            />
            <button
              type="button"
        ...
        <button
          ...
          className="w-full rounded-xl bg-emerald-600 px-4 py-2 font-semibold text-[rgb(var(--app-text))] hover:bg-emerald-500 disabled:opacity-60"
        >
